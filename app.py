...
def main():
    st.set_page_config(page_title="Chat PDF and Web", layout="wide")
    ...
    st.markdown('<h1 style="color: #eb349e;">BreastDOC chatBOT</h1>', unsafe_allow_html=True)
    ...
    st.text_input("Ask a Question from the PDF Files or Website", key=f"user_input_{st.session_state.input_key}", on_change=handle_input)
